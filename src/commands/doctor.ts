...
// Pad a partial version spec (`24`, `24.1`) to a full `major.minor.patch`
// triple so it can be compared as semver. Ranges like `>=24` are valid npm
// engine constraints, but the underlying parser requires all three parts.
