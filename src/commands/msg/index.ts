  ...
  cm msg view 12345 --json`,
    ...
    msg.command('update <message-ref> [content]')
        ...
        .addHelpText(
            ...
            `
Examples:
  cm msg update 12345 "Updated text"
  echo "New content" | cm msg update 12345
  cm msg update 12345 "Fixed typo" --json`,
        )
