...
describe('conversation implicit view', () => {
    ...
    it('cm conversation <ref> routes to view (not unknown command)', async () => {
        const program = createProgram()
        const consoleSpy = vi.spyOn(console, 'log').mockImplementation(() => {})

        await expect(program.parseAsync(['node', 'cm', 'conversation', '100'])).rejects.toThrow(
            'MOCK_API_REACHED',
        )
...
describeEmptyMachineOutput('conversation unread empty output', {
    ...
    run: async (extraArgs) => {
        const program = createProgram()
        await program.parseAsync(['node', 'cm', 'conversation', 'unread', ...extraArgs])
    },
...
describe('conversation with', () => {
    ...
    it('prints the exact 1:1 conversation for a user', async () => {
        ...
        await program.parseAsync(['node', 'cm', 'conversation', 'with', 'Alice'])
    ...
    it('finds the self-conversation when looking up yourself', async () => {
        ...
        await program.parseAsync(['node', 'cm', 'conversation', 'with', 'Me'])
    ...
    it('emits empty JSON array when no 1:1 conversation is found with --json', async () => {
        ...
        await program.parseAsync(['node', 'cm', 'conversation', 'with', 'Alice', '--json'])
    ...
    it('prints a clean error and exits non-zero for ambiguous user refs', async () => {
        ...
        await expect(
            program.parseAsync(['node', 'cm', 'conversation', 'with', 'Alex']),
...
describe('conversation view machine output', () => {
    ...
    it('filters conversation and message fields unless --full is set', async () => {
        ...
        await program.parseAsync(['node', 'cm', 'conversation', 'view', '42', '--json'])
        ...
        await program.parseAsync(['node', 'cm', 'conversation', 'view', '42', '--ndjson'])
        ...
        await program.parseAsync(['node', 'cm', 'conversation', 'view', '42', '--json', '--full'])
...
describe('conversation view with failed batch response', () => {
    ...
    it('throws a clear error when a batched user lookup fails', async () => {
        ...
        await expect(
            program.parseAsync(['node', 'cm', 'conversation', 'view', '42']),
...
describe('conversation mute', () => {
    ...
    it('mutes a conversation with default 60 minutes', async () => {
        ...
        await program.parseAsync(['node', 'cm', 'conversation', 'mute', '42'])
    ...
    it('mutes a conversation with custom minutes', async () => {
        ...
        await program.parseAsync(['node', 'cm', 'conversation', 'mute', '42', '--minutes', '480'])
    ...
    it('shows dry run output', async () => {
        ...
        await program.parseAsync(['node', 'cm', 'conversation', 'mute', '42', '--dry-run'])
    ...
    it('runs validation in dry-run mode', async () => {
        ...
        await expect(
            program.parseAsync(['node', 'cm', 'conversation', 'mute', '42', '--dry-run']),
    ...
    it('rejects non-integer --minutes value', async () => {
        ...
        await expect(
            program.parseAsync(['node', 'cm', 'conversation', 'mute', '42', '--minutes', 'foo']),
...
describe('conversation unmute', () => {
    ...
    it('unmutes a conversation', async () => {
        ...
        await program.parseAsync(['node', 'cm', 'conversation', 'unmute', '42'])
    ...
    it('shows dry run output', async () => {
        ...
        await program.parseAsync(['node', 'cm', 'conversation', 'unmute', '42', '--dry-run'])
    ...
    it('runs validation in dry-run mode', async () => {
        ...
        await expect(
            program.parseAsync(['node', 'cm', 'conversation', 'unmute', '42', '--dry-run']),
        ).rejects.toThrow('conversation not found')
        expect(client.conversations.unmuteConversation).not.toHaveBeenCalled()
    })
})
...
describe('conversation done', () => {
    ...
    it('archives a conversation', async () => {
        ...
        await program.parseAsync(['node', 'cm', 'conversation', 'done', '42'])
    ...
    it('shows dry run output', async () => {
        ...
        await program.parseAsync(['node', 'cm', 'conversation', 'done', '42', '--dry-run'])
    ...
    it('runs validation in dry-run mode', async () => {
        ...
        await expect(
            program.parseAsync(['node', 'cm', 'conversation', 'done', '42', '--dry-run']),
        ).rejects.toThrow('conversation not found')
        expect(client.conversations.archiveConversation).not.toHaveBeenCalled()
    })
})
