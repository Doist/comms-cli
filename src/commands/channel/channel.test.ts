...
describe('channels list', () => {
    ...
    it('errors when both positional and --workspace are provided', async () => {
        ...
        await expect(
            program.parseAsync(['node', 'cm', 'channels', 'Doist', '--workspace', 'Other']),
    ...
    it('lists joined public channels by default (via channels alias)', async () => {
        ...
        await program.parseAsync(['node', 'cm', 'channels'])
    ...
    it('also works via the singular channel command name', async () => {
        ...
        await program.parseAsync(['node', 'cm', 'channel'])
    ...
    it('supports explicit channel list subcommand', async () => {
        ...
        await program.parseAsync(['node', 'cm', 'channel', 'list'])
    ...
    it('lists active public channels and marks whether they are joined', async () => {
        ...
        await program.parseAsync(['node', 'cm', 'channels', '--scope', 'public'])
    ...
    it('lists only discoverable channels in JSON mode', async () => {
        ...
        await program.parseAsync(['node', 'cm', 'channels', '--scope', 'discoverable', '--json'])
    ...
    it('lists archived joined channels with --state archived', async () => {
        ...
        await program.parseAsync(['node', 'cm', 'channels', '--state', 'archived'])
    ...
    it('includes archived state in joined JSON output without --full', async () => {
        ...
        await program.parseAsync(['node', 'cm', 'channels', '--state', 'all', '--json'])
    ...
    it('includes archived state in joined NDJSON output without --full', async () => {
        ...
        await program.parseAsync(['node', 'cm', 'channels', '--state', 'all', '--ndjson'])
    ...
    describeEmptyMachineOutput('empty machine output contract', {
        ...
        run: async (extraArgs) => {
            const program = createProgram()
            await program.parseAsync(['node', 'cm', 'channels', ...extraArgs])
        },
    ...
    it('shows a specific empty state when no active discoverable channels remain', async () => {
        ...
        await program.parseAsync(['node', 'cm', 'channels', '--scope', 'discoverable'])
    ...
    it('rejects invalid scope values', async () => {
        ...
        await expect(
            program.parseAsync(['node', 'cm', 'channels', '--scope', 'invalid']),
    ...
    it('rejects invalid state values', async () => {
        ...
        await expect(
            program.parseAsync(['node', 'cm', 'channels', '--state', 'invalid']),
