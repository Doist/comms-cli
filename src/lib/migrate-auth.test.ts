...
vi.mock('@doist/comms-sdk', () => ({
    CommsApi: mocks.twistApiCtor.mockImplementation(function (this: object, _token: string) {
...
describe('runMigrateLegacyAuth', () => {
    ...
    it('passes comms-cli wiring to cli-core: serviceName, legacy api-token slot, silent flag, no accountForUser override', async () => {
    ...
    it('identifyAccount resolves a CommsAccount from a raw CommsApi + v1 auth metadata on disk', async () => {
