...
describe('parseCommsUrl', () => {
    ...
    it('parses channel URL', () => {
        const result = parseCommsUrl('https://comms.todoist.com/a/12345/ch/67890')
        expect(result).toEqual({ workspaceId: 12345, channelId: 67890 })
    })

    it('parses thread URL', () => {
        const result = parseCommsUrl('https://comms.todoist.com/a/12345/ch/67890/t/111')
        expect(result).toEqual({ workspaceId: 12345, channelId: 67890, threadId: 111 })
    })

    it('parses thread with comment URL', () => {
        const result = parseCommsUrl('https://comms.todoist.com/a/12345/ch/67890/t/111/c/222')
    ...
    it('parses conversation URL', () => {
        const result = parseCommsUrl('https://comms.todoist.com/a/12345/msg/333')
        expect(result).toEqual({ workspaceId: 12345, conversationId: 333 })
    })

    it('parses message URL', () => {
        const result = parseCommsUrl('https://comms.todoist.com/a/12345/msg/333/m/444')
...
describe('parseRef', () => {
    ...
    it('parses URLs', () => {
        const result = parseRef('https://comms.todoist.com/a/12345/ch/67890/t/111')
        expect(result).toEqual({
            type: 'url',
...
describe('resolveThreadId', () => {
    ...
    it('resolves thread URLs', () => {
        expect(resolveThreadId('https://comms.todoist.com/a/12345/ch/67890/t/111')).toBe(111)
    })

    it('resolves thread URLs with comment suffix', () => {
        expect(resolveThreadId('https://comms.todoist.com/a/12345/ch/67890/t/111/c/222')).toBe(111)
    })
...
describe('resolveCommentId', () => {
    ...
    it('resolves comment URLs', () => {
        expect(resolveCommentId('https://comms.todoist.com/a/12345/ch/67890/t/111/c/222')).toBe(222)
    })
})
...
describe('resolveChannelId', () => {
    ...
    it('resolves channel URLs', () => {
        expect(resolveChannelId('https://comms.todoist.com/a/12345/ch/67890')).toBe(67890)
    })
})
...
describe('resolveChannelRef', () => {
    ...
    it('fetches channel by Comms URL via getChannel', async () => {
        ...
        const result = await resolveChannelRef('https://comms.todoist.com/a/1/ch/42', 1)
...
describe('resolveConversationId', () => {
    ...
    it('resolves conversation URLs', () => {
        expect(resolveConversationId('https://comms.todoist.com/a/12345/msg/333')).toBe(333)
    })
})
...
describe('resolveMessageId', () => {
    ...
    it('resolves message URLs', () => {
        expect(resolveMessageId('https://comms.todoist.com/a/12345/msg/333/m/444')).toBe(444)
    })
})
...
describe('classifyCommsUrl', () => {
    it('classifies thread URL', () => {
        expect(classifyCommsUrl('https://comms.todoist.com/a/20/ch/100/t/200')).toEqual({
            entityType: 'thread',
            url: 'https://comms.todoist.com/a/20/ch/100/t/200',
        })
    })

    it('classifies thread+comment URL as comment', () => {
        expect(classifyCommsUrl('https://comms.todoist.com/a/20/ch/100/t/200/c/300')).toEqual({
            entityType: 'comment',
            url: 'https://comms.todoist.com/a/20/ch/100/t/200/c/300',
        })
    })

    it('classifies conversation URL', () => {
        expect(classifyCommsUrl('https://comms.todoist.com/a/20/msg/400')).toEqual({
            entityType: 'conversation',
            url: 'https://comms.todoist.com/a/20/msg/400',
        })
    })

    it('classifies message URL', () => {
        expect(classifyCommsUrl('https://comms.todoist.com/a/20/msg/400/m/500')).toEqual({
            entityType: 'message',
            url: 'https://comms.todoist.com/a/20/msg/400/m/500',
        })
    })
    ...
    it('returns null for channel-only URL', () => {
        expect(classifyCommsUrl('https://comms.todoist.com/a/20/ch/100')).toBeNull()
    })
