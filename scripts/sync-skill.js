...
/**
 * Regenerates skills/comms-cli/SKILL.md from the built skill content.
 *
...
try {
    ...
    const skillPath = join(root, 'skills/comms-cli/SKILL.md')
    await mkdir(dirname(skillPath), { recursive: true })
    await writeFile(skillPath, SKILL_FILE_CONTENT, 'utf-8')
    console.log('skills/comms-cli/SKILL.md has been regenerated')
} catch (err) {
